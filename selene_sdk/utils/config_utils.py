...
import importlib
import random
# from src.utils import get_full_dl
import sys
import time
        ...
        if op == "train":
            ...
            if (
                ...
                if "skf_fold" in operations:
                    ...
                    dataset_n_features = 1 # train_loader.dataset.n_target_features
            ...
            train_model.train_and_crossval()
